...
<form:form action="ResultPage?start=${newlistEmployee.get(0).getQid()}&end=${newlistEmployee.get(newlistEmployee.size()-1).getQid()}" method="post" modelAttribute="employee">
<div class="container">
<div class="jumbotron">
...
<table id="table2">
  ...
  <core:forEach var="questionPaper" items="${newlistEmployee}" ><br/><br/>
